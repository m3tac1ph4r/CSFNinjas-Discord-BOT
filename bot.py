...
async def help(ctx):
	...
	await ctx.send(embed=embed)
client.run('NzY4NDIwOTcwNTA2ODc4OTg4.X5ANyw.gdRExu4S8Qd2nTgCpZsRCQs50FY')

'''
Welcome to the CSFNinjas Discord!
I am CSFNinjas Bot mainly used to store credential for the event
...
.clear amount
Delete as much messages from the channel. Ex .clear 5

.set eventname username:password
Saves your usename and password for that event in this format uname:password. Ex: .set bytecon ashu:pwd

.remove eventname
Delete credentials for that event. Ex: .remove bytecon

.show eventname
Shows credentials for that event. Ex: .show bytecon
